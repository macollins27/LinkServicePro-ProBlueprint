...
interface MiniDemoLeadProps {
  featureName: string;
}

export default function MiniDemoLead({ featureName }: MiniDemoLeadProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Form submission:', { email, company, feature: featureName });
