...
export default function RelatedFeatures3() {
  const features = [
    {
      slug: "dispatch-board-live-map",
      name: "Dispatch Board + Live Map",
      description: "See every crew on screen and act fast"
    },
    {
      slug: "route-optimization",
      name: "Route Optimization",
      description: "Cut drive time and fuel costs"
    },
    {
      slug: "two-way-messaging",
      name: "2-Way SMS",
      description: "Text customers and get replies"
    }
  ];
  ...
  return (
    <section 
      ...
      data-testid="section-related-features"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((feature, idx) => (
            <Link
              ...
              className="bg-white ring-1 ring-slate-200 p-6 shadow-sm hover-elevate active-elevate-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0B5FFF] focus-visible:ring-offset-2 focus-visible:ring-offset-white group"
